# 趣链开发者平台 js SDK
帮助javascript开发者便利的使用趣链开发者平台API
...
qsnark.conf.ACCESS_KEY = 'your app key';
qsnark.conf.SECRET_KEY = ' your app sercet';
qsnark.conf.PHONE = ' your phone';
qsnark.conf.PASSWORD = ' your password';
